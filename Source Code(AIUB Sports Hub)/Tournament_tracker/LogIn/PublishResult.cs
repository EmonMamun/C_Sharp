...
namespace LogIn
{
    public partial class PublishResult : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into SET_RESULT_BASKETBALL_MATCH values (@id, @home, @away, @date, @result)";
        ...
        private void PublishResult_Load(object sender, EventArgs e)
        {
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "delete from SET_RESULT_BASKETBALL_MATCH where ID=@id";
            SqlCommand cmd = new SqlCommand(query, con);

            cmd.Parameters.AddWithValue("@id", textBox1.Text);
            /*cmd.Parameters.AddWithValue("@home", textBox2.Text);
            cmd.Parameters.AddWithValue("@away", textBox4.Text);
